...
async def about():
    ...
    return {
        ...
        "export": {
            "excel": {
                "endpoint": "POST /export/excel - Upload demo and get formatted Excel file",
                "description": "Professional multi-sheet Excel export for analysts and coaches",
                "sheets": {
                    "Overview": "Player stats table with K/D/A, ADR, Rating, etc.",
                    "Kills": "Detailed list of every kill event with weapons and modifiers",
                    "Damages": "Detailed list of damage events (limited to 5000 rows)",
                    "Advanced": "TTD, Clutch, Utility, Opening Duels, Multi-kills per player",
                    "Rounds": "Round-by-round data with winners and reasons",
                },
                "formatting": "Headers are bold with dark blue background, team color-coding, auto-filters enabled",
                "filename": "{map_name}_analysis.xlsx",
            },
            "json": "GET /analyze/{job_id}/download?format=json - Download full analysis as JSON",
            "ndjson": "GET /analyze/{job_id}/download?format=ndjson - Newline-delimited JSON for streaming",
        }
    }
