...
const RADAR_URLS = {
    'de_dust2': _RADAR_BASE + '/de_dust2.png',
    'de_mirage': _RADAR_BASE + '/de_mirage.png',
    'de_inferno': _RADAR_BASE + '/de_inferno.png',
    'de_nuke': _RADAR_BASE + '/de_nuke.png',
    'de_overpass': _RADAR_BASE + '/de_overpass.png',
