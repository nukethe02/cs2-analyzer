...
# KAST bug (>100%) fixed 2026-02-14: float64→string steamid matching.
#
GOLDEN_EXPECTATIONS = {
    # Re-baselined 2026-02-14 after knife-round exclusion, suicide exclusion,
    # flash-assist separation, and KAST float64→string fix.
    # K/D/A values verified exact-match with Leetify screenshots.
    "Docobo": {
        "team": "CT",
        "hltv_rating": 1.21,
        "kast_percentage": 73.3,
        "impact_rating": 1.87,
        "kills": 25,
        "deaths": 21,
        "adr": 84.3,
